...
- The [EntryService](runtime/services/shared.md)
...
- If existing connections are returned the [EntryService](runtime/services/shared.md) opens the `ConnectionsPopupComponent` and passes the returned connections to the popup. The user can select devices and delete their connections.
...
- If devices were deleted, the [EntryService](runtime/services/shared.md#entryservice) performs the connection check again:
```
